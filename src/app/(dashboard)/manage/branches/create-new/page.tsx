    ...
    <div className="max-w-5xl mx-auto space-y-6 p-6">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader className="pb-3 border-b">
              ...
              <CardDescription className="text-xs">
                Enter the branch owner details for system access.
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-4 space-y-3.5">
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Owner Full Name *</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="text-xs font-medium text-foreground">Owner Email Address (Permanent ID) *</label>
                <input
                  type="email"
          ...
          <div className="space-y-6">
            <Card>
              <CardHeader className="pb-3 border-b">
                ...
                <CardDescription className="text-xs">
                  Basic information about the distribution hub.
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-4 space-y-3.5">
                <div className="space-y-1.5">
                  ...
                  <input
                    type="text"
                    placeholder="e.g. Islamabad Pure Spring"
                    {...register("name")}
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <option value="COMMERCIAL_DISTRIBUTION">Wholesale / Retail</option>
                    </select>
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      {...register("city")}
                      className={`w-full h-9 rounded-md border bg-background px-3 text-xs outline-none focus:ring-1 ${errors.city ? "border-destructive focus:ring-destructive" : "border-input focus:ring-ring"}`}
                    />
              ...
              <CardContent className="pt-4 grid grid-cols-2 gap-3">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className={`w-full h-9 rounded-md border bg-background px-3 text-xs font-mono outline-none focus:ring-1 ${errors.latitude ? "border-destructive focus:ring-destructive" : "border-input focus:ring-ring"}`}
                  />
                </div>
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className={`w-full h-9 rounded-md border bg-background px-3 text-xs font-mono outline-none focus:ring-1 ${errors.longitude ? "border-destructive focus:ring-destructive" : "border-input focus:ring-ring"}`}
                  />
                </div>
              </CardContent>
            </Card>
        ...
        <div className="flex items-center justify-end gap-3 border-t pt-4">
          ...
          <Button type="submit" variant="create" size="sm" disabled={isPending || !isValid} className="min-w-36 bg-sky-600 hover:bg-sky-700">
            {isPending ? (
